...
public class TouchFilterableLinearLayout extends LinearLayout implements TouchFilterableLayout<LinearLayout> {
    ...
    public TouchFilterableLinearLayout(Context context) {
        this(context, null);
    }

    public TouchFilterableLinearLayout(Context context, AttributeSet attrs) {
