...
public class EndedVideoCallAVSMetricsEvent extends AVSMetricEvent {


    public EndedVideoCallAVSMetricsEvent(AvsMetrics avsMetrics) {
        try {
    ...
    public String getName() {
        return "calling.avs_metrics_ended_video_call";
    }
}
