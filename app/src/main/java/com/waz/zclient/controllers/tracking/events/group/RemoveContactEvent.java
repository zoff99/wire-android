...
public class RemoveContactEvent extends Event {

    public RemoveContactEvent(boolean result, int participantsCount) {
        rangedAttributes.put(RangedAttribute.MEMBERS, participantsCount);
        attributes.put(Attribute.REMOVED_CONTACT, ConfirmationResponse.getValue(result));
    }
