...
public class PlayedSoundCloudMessageEvent extends Event {

    public PlayedSoundCloudMessageEvent(boolean playedByReceiver, String conversationType) {
    ...
    public String getName() {
        return "media.played_soundcloud_message";
    }
}
