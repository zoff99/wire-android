...
public class RequestedPhoneVerificationCallEvent extends Event {

    public RequestedPhoneVerificationCallEvent(OutcomeAttribute outcomeAttribute, String errorMessage, RegistrationEventContext context) {
    ...
    public String getName() {
        return "registration.requested_phone_verification_call";
    }
}
