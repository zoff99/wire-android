...
public class OpenedPhoneSignUpEvent extends Event {

    public OpenedPhoneSignUpEvent(RegistrationEventContext context) {
    ...
    public String getName() {
        return "registration.opened_phone_signup";
    }
}
