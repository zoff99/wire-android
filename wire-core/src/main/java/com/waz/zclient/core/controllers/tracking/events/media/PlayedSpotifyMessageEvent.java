...
public class PlayedSpotifyMessageEvent extends Event {

    public PlayedSpotifyMessageEvent(boolean playedByReceiver, String conversationType) {
    ...
    public String getName() {
        return "media.played_spotify_message";
    }
}
