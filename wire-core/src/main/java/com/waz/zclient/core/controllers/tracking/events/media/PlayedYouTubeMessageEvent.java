...
public class PlayedYouTubeMessageEvent extends Event {

    public PlayedYouTubeMessageEvent(boolean playedByReceiver, String conversationType) {
    ...
    public String getName() {
        return "media.played_youtube_message";
    }
}
