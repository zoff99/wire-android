...
public class EnteredNameEvent extends Event {

    public EnteredNameEvent(OutcomeAttribute outcomeAttribute, String errorMessage, RegistrationEventContext context) {
    ...
    public String getName() {
        return "registration.entered_name";
    }
}
