...
public class SuccessfullyUploadedFileEvent extends Event {

    public SuccessfullyUploadedFileEvent(String fileMimeType, int fileSizeInBytes, int uploadDurationInSeconds) {
        ...
        rangedAttributes.put(RangedAttribute.FILE_UPLOAD_DURATION, uploadDurationInSeconds);
    }

    @NonNull
    @Override
    public String getName() {
        return "file.successfully_uploaded_file";
    }
}
