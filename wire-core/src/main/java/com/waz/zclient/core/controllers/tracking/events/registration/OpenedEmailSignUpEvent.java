...
public class OpenedEmailSignUpEvent extends Event {

    public OpenedEmailSignUpEvent(RegistrationEventContext context) {
    ...
    public String getName() {
        return "registration.opened_email_signup";
    }
}
