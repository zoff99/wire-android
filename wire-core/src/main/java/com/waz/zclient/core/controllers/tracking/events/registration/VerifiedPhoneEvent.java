...
public class VerifiedPhoneEvent extends Event {

    public VerifiedPhoneEvent(OutcomeAttribute outcomeAttribute,
                              String errorCode,
                              String errorMessage,
                              RegistrationEventContext context) {
        ...
        if (outcomeAttribute.equals(OutcomeAttribute.FAIL)) {
            attributes.put(Attribute.ERROR, errorCode);
            attributes.put(Attribute.ERROR_MESSAGE, errorMessage);
        }
    }
    ...
    public String getName() {
        return "registration.verified_phone";
    }
}
