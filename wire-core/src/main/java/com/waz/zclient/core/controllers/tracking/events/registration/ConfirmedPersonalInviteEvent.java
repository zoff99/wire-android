...
public class ConfirmedPersonalInviteEvent extends Event {

    public ConfirmedPersonalInviteEvent(RegistrationEventContext context) {
    ...
    public String getName() {
        return "registration.confirmed_personal_invite";
    }
}
