...
public class EnteredEmailAndPasswordEvent extends Event {

    public EnteredEmailAndPasswordEvent(OutcomeAttribute outcomeAttribute, String errorMessage, RegistrationEventContext context) {
    ...
    public String getName() {
        return "registration.entered_email_and_password";
    }
}
