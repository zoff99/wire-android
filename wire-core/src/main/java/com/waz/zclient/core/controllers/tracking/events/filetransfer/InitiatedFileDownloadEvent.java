...
public class InitiatedFileDownloadEvent extends Event {

    public InitiatedFileDownloadEvent(String fileMimeType, int fileSizeInBytes) {
    ...
    public String getName() {
        return "file.initiated_file_download";
    }
}
