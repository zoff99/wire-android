...
public class VerifiedEmailEvent extends Event {

    public VerifiedEmailEvent(OutcomeAttribute outcomeAttribute, String errorMessage, RegistrationEventContext context) {
    ...
    public String getName() {
        return "registration.verified_email";
    }
}
